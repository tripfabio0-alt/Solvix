    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <header className="relative z-20 mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-5">
        <a href="#" className="flex items-center gap-2">
          <img src={logo} alt="Solvix" className="h-14 w-14 object-contain" />
          <span className="text-2xl font-bold tracking-wider">SOLVIX</span>
        </a>
          ...
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-5">
            <div className="lg:col-span-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold tracking-wider">SOLVIX</span>
              </div>
